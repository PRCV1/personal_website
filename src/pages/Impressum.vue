<template>
    <div class="container py-5">
        <Section title="Impressum" :center-title="true">
            <div class="row" :class="bgClass">
                ...
                <div class="col-12 mb-3">
                    <SimpleTextblock title="Haftung für Inhalte">
                        ...
                        § 7
                        Abs.1
                        TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§ 8
                        bis
                        10
                        TMG sind
                ...
                <div class="col-12 mb-3">
                    <SimpleTextblock title="Haftung für Links">
                        ...
                        Seiten
                        ist
                        stets der jeweilige Anbieter oder Betreiber der Seiten verantwortlich. Die verlinkten Seiten
                        wurden
                        zum
                ...
                <div class="col-12 mb-3">
                    <SimpleTextblock title="Urheberrecht">Die durch die Seitenbetreiber erstellten Inhalte und Werke auf
                        diesen
                        Seiten
                        ...
                        Downloads und
                        Kopien dieser Seite sind nur für den privaten, nicht kommerziellen Gebrauch gestattet. Soweit
                        die
                        Inhalte auf
                        ...
                        werden
                        wir
                        derartige Inhalte umgehend entfernen.</SimpleTextblock>
                </div>
                <div class="col-12 mb-3">
                    <SimpleTextblock title="Datenschutz">Die Nutzung unserer Webseite ist in der Regel ohne Angabe
                        personenbezogener
                        Daten möglich. Soweit auf unseren
                        Seiten personenbezogene Daten (beispielsweise Name, Anschrift oder eMail-Adressen) erhoben
                        werden,
                        erfolgt dies,
                        soweit möglich, stets auf freiwilliger Basis. Diese Daten werden ohne Ihre ausdrückliche
                        Zustimmung
                        nicht an
                        Dritte weitergegeben. Wir weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der
                        Kommunikation
                        ...
                        der
                        unverlangten
                        Zusendung von Werbeinformationen, etwa durch Spam-Mails, vor.</SimpleTextblock>
                </div>
                <div class="col-12 mb-3">
                    <SimpleTextblock title="Google Analytics">Diese Website benutzt Google Analytics, einen
                        Webanalysedienst
                        der
                        ...
                        Analyse
                        der
                        Benutzung der Website durch Sie ermöglicht. Die durch den Cookie erzeugten Informationen über
                        Ihre
                        Benutzung
                        dieser Website (einschließlich Ihrer IP-Adresse) wird an einen Server von Google in den USA
                        übertragen
                        und
                        dort
