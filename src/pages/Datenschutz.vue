        ...
        <div class="col-12 mb-3">
            <SimpleTextblock title="Datenschutz auf einen Blick">
                ...
                <SimpleTextblock
                    ...
                    :title="TitleSize.h5"
                >Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem Impressum dieser Website entnehmen.</SimpleTextblock>
                <SimpleTextblock title="Wie erfassen wir Ihre Daten?" :title="TitleSize.h5">
                    ...
                    <br />
                    <br />Klicken Sie Hier, um das Tracking durch Google Analytics zu deaktivieren oder Hier zum aktivieren.
                </SimpleTextblock>
                <SimpleTextblock
        ...
        <div class="col-12 mb-3">
            <SimpleTextblock title="Allgemeine Hinweise und Pflichtinformationen">
                ...
                <SimpleTextblock
                    ...
                    :title-size="TitleSize.h5"
                >Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine bereits erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per E-Mail an uns. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unberührt.</SimpleTextblock>
                <SimpleTextblock
                ...
                <SimpleTextblock
                    title="Auskunft, Sperrung, Löschung und Berichtigung"
                    :title-size="TitleSize.h5"
                >Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden.</SimpleTextblock>
                <SimpleTextblock
                ...
                >
                    ...
                    </ul>Wenn Sie die Verarbeitung Ihrer personenbezogenen Daten eingeschränkt haben, dürfen diese Daten – von ihrer Speicherung abgesehen – nur mit Ihrer Einwilligung oder zur Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen oder zum Schutz der Rechte einer anderen natürlichen oder juristischen Person oder aus Gründen eines wichtigen öffentlichen Interesses der Europäischen Union oder eines Mitgliedstaats verarbeitet werden.
                </SimpleTextblock>
            </SimpleTextblock>
        </div>
        <div class="col-12 mb-3">
