<template>
    <div class="container py-5">
        <Section title="Datenschutz" :center-title="true">
            <div class="row" :class="bgClass">
                <div class="col-12 mb-3">
                    <SimpleTextblock title="Datenschutz auf einen Blick">
                        <SimpleTextblock title="Allgemeine Hinweise" :title-size="TitleSize.h5">Die folgenden Hinweise
                            geben
                            ...
                            unserer unter diesem Text aufgeführten Datenschutzerklärung.</SimpleTextblock>
                        <SimpleTextblock title="Wer ist verantwortlich für die Datenerfassung auf dieser Website?"
                            :title="TitleSize.h5">Die Datenverarbeitung auf dieser Website erfolgt durch den
                            Websitebetreiber. Dessen Kontaktdaten können Sie dem Impressum dieser Website entnehmen.
                        </SimpleTextblock>
                        <SimpleTextblock title="Wie erfassen wir Ihre Daten?" :title="TitleSize.h5">
                            ...
                            <br />
                            <br />Klicken Sie Hier, um das Tracking durch Google Analytics zu deaktivieren oder Hier zum
                            aktivieren.
                        </SimpleTextblock>
                        <SimpleTextblock title="Welche Rechte haben Sie bezüglich Ihrer Daten?" :title="TitleSize.h5">
                            ...
                            zu.
                            <br />
                            <br />Außerdem haben Sie das Recht, unter bestimmten Umständen die Einschränkung der
                ...
                <div class="col-12 mb-3">
                    <SimpleTextblock title="Allgemeine Hinweise und Pflichtinformationen">
                        <SimpleTextblock title="Datenschutz" :title-size="TitleSize.h5">
                            ...
                            <br />
                            <br />Wir weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der
                            Kommunikation
                            per E-Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz der Daten vor dem
                            Zugriff
                            durch Dritte ist nicht möglich.
                        </SimpleTextblock>
                        <SimpleTextblock title="Hinweis zur verantwortlichen Stelle" :title-size="TitleSize.h5">
                            Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:
                            <br />
                            <br />Lukas Müller
                            <br />Laraustraße 16
                            <br />36269 Philippsthal
                            <br />E-Mail:
                            <a href="mailto:privat@lukasmueller.info">privat@lukasmueller.info</a>
                            <br />
                            <br />Verantwortliche Stelle ist die natürliche oder juristische Person, die allein oder
                            gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen
                            Daten
                            (z.B. Namen, E-Mail-Adressen o. Ä.) entscheidet.
                        </SimpleTextblock>
                        <SimpleTextblock title="Widerruf Ihrer Einwilligung zur Datenverarbeitung"
                            :title-size="TitleSize.h5">Viele Datenverarbeitungsvorgänge sind nur mit Ihrer
                            ausdrücklichen
                            Einwilligung möglich. Sie können eine bereits erteilte Einwilligung jederzeit widerrufen.
                            Dazu
                            reicht eine formlose Mitteilung per E-Mail an uns. Die Rechtmäßigkeit der bis zum Widerruf
                            erfolgten Datenverarbeitung bleibt vom Widerruf unberührt.</SimpleTextblock>
                        <SimpleTextblock
                            ...
                            <br />
                            <br />Werden Ihre personenbezogenen Daten verarbeitet, um Direktwerbung zu betreiben, so
                            haben
                            ...
                            personenbezogenen
                            Daten anschließend nicht mehr zum Zwecke der Direktwerbung verwendet (Widerspruch nach Art.
                            21
                            Abs. 2 DSGVO).
                        </SimpleTextblock>
                        <SimpleTextblock title="Beschwerderecht bei der zuständigen Aufsichtsbehörde"
                            :title-size="TitleSize.h5">Im Falle von Verstößen gegen die DSGVO steht den Betroffenen ein
                            ...
                            Rechtsbehelfe.</SimpleTextblock>
                        <SimpleTextblock title="Recht auf Datenübertragbarkeit" :title-size="TitleSize.h5">Sie haben das
                            Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erfüllung eines Vertrags
                        ...
                        <SimpleTextblock title="SSL- bzw. TLS-Verschlüsselung" :title-size="TitleSize.h5">
                            ...
                            Ihrer Browserzeile.
                            <br />
                            <br />Wenn die SSL- bzw. TLS-Verschlüsselung aktiviert ist, können die Daten, die Sie an uns
                            übermitteln, nicht von Dritten mitgelesen werden.
                        </SimpleTextblock>
                        <SimpleTextblock title="Auskunft, Sperrung, Löschung und Berichtigung"
                            :title-size="TitleSize.h5">
                        ...
                        <SimpleTextblock title="Recht auf Einschränkung der Verarbeitung" :title-size="TitleSize.h5">
                            ...
                            </ul>Wenn Sie die Verarbeitung Ihrer personenbezogenen Daten eingeschränkt haben, dürfen
                            diese
                ...
                <div class="col-12 mb-3">
                    <SimpleTextblock title="Datenerfassung auf unserer Website">
                        <SimpleTextblock title="Cookies" :title-size="TitleSize.h5">
                            ...
                            <br />
                            <br />Die meisten der von uns verwendeten Cookies sind so genannte “Session-Cookies”. Sie
                            werden
                            ...
                            <br />
                            <br />Sie können Ihren Browser so einstellen, dass Sie über das Setzen von Cookies
                            informiert
                            ...
                            eingeschränkt sein.
                            <br />
                            <br />Cookies, die zur Durchführung des elektronischen Kommunikationsvorgangs oder zur
                        ...
                        <SimpleTextblock title="Anfrage per E-Mail, Telefon oder Telefax" :title-size="TitleSize.h5">
                            ...
                            Einwilligung weiter.
                            <br />
                            <br />Die Verarbeitung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO,
                            sofern
                            ...
                            auf
                            Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) und / oder auf unseren berechtigten
                            Interessen
                            (Art. 6 Abs. 1 lit. f DSGVO), da wir ein berechtigtes Interesse an der effektiven
                            Bearbeitung
                            der an uns gerichteten Anfragen haben.
                            <br />
                            <br />Die von Ihnen an uns per Kontaktanfragen übersandten Daten verbleiben bei uns, bis Sie
                            uns
                ...
                <div class="col-12 mb-3">
                    <SimpleTextblock title="Plugins und Tools">
                        <SimpleTextblock title="Google Web Fonts" :title-size="TitleSize.h5">
                            ...
                            <br />
                            <br />Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von
                            Google
                            ...
                            <br />
                            <br />Wenn Ihr Browser Web Fonts nicht unterstützt, wird eine Standardschrift von Ihrem
                            Computer
                            genutzt.
                            <br />
                            <br />Weitere Informationen zu Google Web Fonts finden Sie unter
