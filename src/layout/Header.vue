<template>
    <header class="py-md-5 py-3" :class="bgClass">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="row" :class="textClass">
                        ...
                        <div class="col-md-10 text-md-start text-center">
                            ...
                            <ul class="list-inline">
                                <li v-for="(item, index) in socialLinks" :key="index" class="list-inline-item">
                ...
                <div class="col-12 col-md-auto d-flex justify-content-center">
                    <div class="form-check form-switch" @click="setIsDarkmode(!isDarkmode)">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked"
                            v-model="isDarkmode" />
                        <label :class="textClass" class="form-check-label" for="flexSwitchCheckChecked"> {{ isDarkmode ? "Helles Design" : "Dunkles Design" }}
                        </label>
                    </div>
                </div>
            </div>
...
const { isDarkmode, setIsDarkmode, textClass, bgClass } = useDarkmode()
...
const socialLinks: ISocialMedia[] = [
    {
        url: "https://twitter.com/luk4slol",
        icon: "bi bi-twitter",
    },
    {
        url: "https://github.com/PRCV1",
        icon: "bi bi-github",
    },
    {
        url: "https://www.instagram.com/luk4slol/",
